...
angular
	...
	.controller('Change-Password', function ($scope, restApi, $routeParams ,session) {
		...
		$scope.reset = function () {
			...
			{
				$scope.newPassForm.passDoMatch = true;
				return;
			}
			$scope.progress = true;
	 ...
	 */
	.controller('leads', function ($rootScope, $scope, restApi, $routeParams ,PaginationEx, Confirm, Notify, $moment, iDate, cfg) {
		$scope.cfg = cfg;
		$scope.iDate = iDate;
		$scope._parm={};
		...
		$scope.pagination.onChange(function (p) {
			...
			restApi.get('/staff/leads', { params: p.getParams() }).success(function (data) {
	 ...
	 */
	.controller('carriers', function ($rootScope, $scope, $routeParams ,restApi, PaginationEx, Confirm, Notify, $moment) {
